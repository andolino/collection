<div class="cont-add-member row none">
	<div class="col-4">
		<a href="javascript:void(0);" class="float-right pr-2 pb-2" id="loadPage" data-link="tbl-monthly-bills" data-badge-head="MONTHLY BILLS"
		...
		<form id="frm-add-monthly-bills">
			<div class="row">
					...
					<div class="col-12">
						...
						<input type="text" class="form-control form-control-sm font-12" id="month" name="month">
					</div>
					<div class="col-12">
					...
					<div class="col-12">
						...
						<input type="text" class="form-control form-control-sm font-12" id="amount" name="amount">
					</div>
					<div class="col-12">
